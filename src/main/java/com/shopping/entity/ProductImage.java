...
public class ProductImage extends BaseEntity { //ProductImage01
    ...
    private String oriImageName ; // 업로드 된파일의 원본이미지 이름
    ...
    //이미지 정보를 업데이트해주는 메소드
    public  void  updateProduct(String oriImageName, String imageNamem, String imageUrl){
